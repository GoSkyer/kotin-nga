...
# in /Users/qeeniao/Library/Android/sdk/tools/proguard/proguard-android.txt
...
################common###############
 #实体类不参与混淆
-keep class com.ydl.jie.data.** {*;}
-keep class com.jess.arms.widget.** { *; } #自定义控件不参与混淆
-keep class * implements android.os.Parcelable {
  public static final android.os.Parcelable$Creator *;
}
-keepnames class * implements jahva.io.Serializable
...
## 拦截器
-keep class com.ydl.jie.common.interceptor.** { *; }
## 登陆token
...
#-keep interface com.jess.arms.utils.* {*;}
# Favor
...
#小米推送
-keep class com.ydl.jie.receive.XiaoMiMessageReceiver {*;}
# bugly
